...
public class MultipleEncodeCircularDecodeTest {

    public static void main(String[] args) {

        int object_population_size = ONE_MILLION;
        int hash_length_in_bits = 18;
        ...
        CircularHash h = new CircularHash(hash_length_in_bits, hash_overlap, num_hashes, balanced_rep_size);
